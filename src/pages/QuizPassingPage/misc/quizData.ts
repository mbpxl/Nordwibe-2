        ...
        questions: [
          {
            ...
            question:
              "Что нужно сделать в первую очередь перед поиском квартиры?",
            description: "",
        ...
        questions: [
          {
            uuid: "ddd11111-dddd-dddd-dddd-dddddddddddd",
            question:
              "Какой рекомендуемый размер финансовой подушки безопасности?",
            description: "",
            image_url: "/images/question1.jpg",
            answers: [
              {
    ...
    quiz: [
      {
        ...
        questions: [
          ...
          },
          {
            uuid: "eee22222-eeee-eeee-eeee-eeeeeeeeeeee",
            question:
              "Что поможет сделать распределение домашних обязанностей честным?",
            description: "",
            image_url: "/images/question2.jpg",
            answers: [
              {
                ...
                answer:
                  "Составить список задач и определить, кто за что отвечает",
                is_correct: true,
              },
              {
