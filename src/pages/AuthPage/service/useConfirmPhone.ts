...
import type { ConfirmPhoneRequestTypes, ConfirmPhoneResponseTypes } from "../types/ConfirmPhoneTypes";
...
export const useConfirmPhone = (
  ...
  return {mutate, response: data, isError, isPending};
};

const confirmPhone = async(payload: ConfirmPhoneRequestTypes): Promise<AxiosResponse<ConfirmPhoneResponseTypes>> => {
