...
import { carouselImages } from "../../../misc/carouselImages";
  ...
  return (
    <div className="w-full max-w-6xl mx-auto rounded-xl mb-1 overflow-hidden shadow-2xl lg:w-[640px] lg:h-[360px] lg:flex-shrink-0">
      <Swiper
        ...
        className="w-full h-[155px] lg:h-[360px]"
      >
          ...
          <SwiperSlide key={index}>
            <div className="relative w-full h-full">
              <img
                ...
                className={`w-full h-full object-cover ${index === 0 ? "lg:object-cover" : "lg:object-left"}`}
              />
